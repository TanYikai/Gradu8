...
public class ScoreManager : MonoBehaviour {
    ...
    //For Statistics
    public Text statsHiScore;
    public Text statsJellyScore;
	...
	void Start () {
        ...
        if (PlayerPrefs.HasKey("HighJScore"))
        {
            hiJellyScoreCount = PlayerPrefs.GetInt("HighJScore");
        }
		//powerupMultiplier = 4;
	}
	...
	void Update () {
        ...
        if (FindObjectOfType<GameManager>().tut == false)
        {
            ...
            if (jellyScoreCount > hiJellyScoreCount)
            {
                hiJellyScoreCount = jellyScoreCount;
                PlayerPrefs.SetFloat("HighJScore", hiJellyScoreCount);//saves hiScore into computer
            }

            scoreText.text = "score : " + Mathf.Round(scoreCount);
            hiScoreText.text = "High Score : " + Mathf.Round(hiScoreCount); 
            statsHiScore.text = Mathf.Round(hiScoreCount).ToString();
        ...
        statsJellyScore.text = hiJellyScoreCount.ToString();
